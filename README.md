...
Version 1.2.0 was tested in game with Reforge, alone and together with
RainbowFlame and BurningTertium. `/reforge` reported all files active and the
barrel effects worked, with no errors.
